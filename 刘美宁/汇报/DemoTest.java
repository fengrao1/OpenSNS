...
public class DemoTest extends BaseTest {
	...
	public Object[][] createNews() throws IOException {
		...
		return edp.getTestDataByExcel("E:\\project--three\\OpenSNS数据驱动.xlsx","Sheet2");// 要测试的文档
	}
	...
	public Object[][] createAdd() throws IOException {
		ExcelDataProvider edp = new ExcelDataProvider();
		return edp.getTestDataByExcel("E:\\project--three\\OpenSNS数据驱动.xlsx","Sheet3");// 要测试的文档
	}
	...
	@Test(description="扩展-云市场-安装插件",priority=26)//失败
	public void test33() throws InterruptedException{
		   ...
		   //[ 注销 ]
		   if(!webtest.isElementPresent("link=登录")){
			  ...
			  webtest.click("xpath=//*[@id='main-container']/div[1]/div/div/div[2]/div[1]/div[2]/div/a[1]");//登录按钮
			  // webtest.click("xpath=/html/body/div[5]/div/div[1]/div/div/div[2]/div[1]/div[2]/div/a[1]");
	...
	public void test35() throws InterruptedException{
		   ...
		   webtest.click("link=未安装");//安装气的插件
		   webtest.click("xpath=//*[@id='main']/div/div[4]/div/div/div/div/div/div[5]/div/a");
		   assertTrue(webtest.isTextPresent("暂时还没有内容"));
		   Thread.sleep(5000);
	}
	...
	public void test36() throws InterruptedException{
	       ...
	       ((JavascriptExecutor) driver).executeScript(jsStrToSetAtt, textEle, "class", "mega-menu-dropdown active open");
		   webtest.click("link=插件管理");
		   webtest.click("xpath= //*[@id='main']/div/div[4]/div/div/div/div[4]/div/div[5]/div/a[3]");//卸载天气的插件
		   webtest.click("link=未安装");
		 //*[@id="main"]/div/div[4]/div/div/div/div[4]/div/div[5]/div/a[3]
		   Thread.sleep(3000);
		   assertTrue(webtest.isTextPresent("紫叶随风"));
	}
	@Test(description="模块管理-安装专辑",priority=30)
	public void test38() throws InterruptedException{
		   ...
		   Thread.sleep(3000);
		   assertTrue(webtest.isTextPresent("专辑"));
		   Thread.sleep(3000);
	}
	@Test(description="模块管理-卸载专辑",priority=31)
	public void test39() throws InterruptedException{
	       ...
	       ((JavascriptExecutor) driver).executeScript(jsStrToSetAtt, textEle, "class", "mega-menu-dropdown active open");
		   webtest.click("link=模块管理");
		   webtest.click("xpath=//*[@id='main']/div/div[3]/div/ul/li[3]/div[2]/div[3]/div[1]/a[2]");//卸载专辑模块
		   webtest.click("xpath=//*[@id='submit']");
		   Alert alert = driver.switchTo().alert();
		   Assert.assertEquals("确认该操作吗？", alert.getText());
		   alert.accept();
	...
	public Object[][] createData() throws IOException {
		ExcelDataProvider edp = new ExcelDataProvider();
		return edp.getTestDataByExcel("E:\\project--three\\OpenSNS数据驱动.xlsx","Sheet1");// 要测试的文档
	}
...
//		   Thread.sleep(1000);
	...
	public Object[][] addPlate() throws IOException {
		ExcelDataProvider edp = new ExcelDataProvider();
		return edp.getTestDataByExcel("E:\\project--three\\OpenSNS数据驱动.xlsx","Sheet4");// 要测试的文档
	}
