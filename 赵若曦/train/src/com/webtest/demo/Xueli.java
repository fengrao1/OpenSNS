...
//		System.setProperty("webdriver.gecko.driver", "G:\\Sel\\geckodriver.exe");
...
//		Thread.sleep(3000);
//		wd.findElement(By.name("username")).sendKeys("1140460261@qq.com");
//		wd.findElement(By.name("password")).sendKeys("zaijian.3");
