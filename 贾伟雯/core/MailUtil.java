...
public class MailUtil {
    ...
    static String from = "贾伟雯";

    static String user = "18330919107@163.com";
    static String password = "jww18731179963";//授权码 用户中心
    ...
    public static void main(String args[]) throws UnsupportedEncodingException
    {
    	...
    	MailUtil.sendEmail("651769329@qq.com", "星期二", "F:\\testcase\\report\\HTML\\2019-10-56-10_56_56JWW-result.html");
    }
