...
//	
   ...
   /** 消息提醒 **/
	...
	public void Remind1() throws Exception{
		...
		soft.assertTrue(webtest.isTextPresent("用户消息"));
//		assertTrue(webtest.isTextPresent("快去看看吧"));
	...
	public void Remind3() throws Exception{
		...
		Thread.sleep(2000);
		SoftAssert soft =new SoftAssert();
		soft.assertTrue(webtest.isTextPresent("加载更多"));
		Thread.sleep(2000);
		webtest.click("xpath=//*[@class=\"close\"]/span[1]");
	}
   ...
   /** 查看排行榜 **/  
	...
	public void Invite2() throws Exception{
		...
		webtest.alertAccept();
		assertTrue(webtest.isTextPresent("兑换成功"));
		Thread.sleep(2000);
	}
	...
	public void Collection() throws Exception{
		...
		Thread.sleep(1000);
		assertTrue(webtest.isTextPresent("我的收藏"));
	}
}
