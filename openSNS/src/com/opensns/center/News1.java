...
public class News1 extends BaseTest{
	@DataProvider(name="number")
	public Object[][] words0() throws Exception{
		ExcelDataProvider d = new ExcelDataProvider();
		return d.getTestDataByExcel("data/fengrao/TestData3.xlsx","Sheet1");
	}
	@DataProvider(name="TestData")
	public Object[][] words() throws Exception{
		ExcelDataProvider d = new ExcelDataProvider();
		return d.getTestDataByExcel("data/fengrao/TestData1.xlsx","Sheet1");
	}
	@BeforeClass
