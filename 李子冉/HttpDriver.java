...
public class HttpDriver {
	...
	public static String doGetForEncoder(String url, String para) throws Exception {
		...
		HttpGet get = new HttpGet("http://10.7.90.21:8080/Supermarket" + url + "?" + content);
		respone = httpClient.execute(get);
		HttpEntity entity = respone.getEntity();
	...
	public static String doGet(String url,Map<String, Object> para,CookieStore cookie) throws Exception{
...
//		post.setHeader("cookie","login=true");//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11删除
